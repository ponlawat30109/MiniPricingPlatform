export const RULE_SERVICE_URL = process.env.NEXT_PUBLIC_RULE_SERVICE_URL || 'http://localhost:5000';
export const PRICING_SERVICE_URL = process.env.NEXT_PUBLIC_PRICING_SERVICE_URL || 'http://localhost:8080';
...
export async function calculatePrice(request: QuoteRequest): Promise<QuoteResponse> {
